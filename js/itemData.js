...
const itemInfo = [
  ...
  // LADIES TANK -------------------------------------------------------------- DM138L
  {
    ...
    linkAttr_info: 'ladiestank.html',
    linkAttr_vendor: 'http://www.helinger.com/ProductResults/?SearchTerms=tank%20top',
    productImages: {
      items: {
        Turquoise_Frost: 'images/productImages/ladiestank/Turquoise_Frost.png',
        Black_Frost: 'images/productImages/ladiestank/Black_Frost.png',
        Fuchsia_Frost: 'images/productImages/ladiestank/Fuchshia_Frost.png',
        Grey_Frost: 'images/productImages/ladiestank/Grey_Frost.png',
        Navy_Frost: 'images/productImages/ladiestank/Navy_Frost.png',
        Purple_Frost: 'images/productImages/ladiestank/Purple_Frost.png',
        Red_Frost: 'images/productImages/ladiestank/Red_Frost.png',
        Royal_Frost: 'images/productImages/ladiestank/Royal_Frost.png',
        White: 'images/productImages/ladiestank/White.png',
      },
      item_thumbnails: {
        Turquoise_Frost: 'images/productImages/ladiestank/Turquoise_Frost-th.png',
        Black_Frost: 'images/productImages/ladiestank/Black_Frost-th.png',
        Fuchsia_Frost: 'images/productImages/ladiestank/Fuchshia_Frost-th.png',
        Grey_Frost: 'images/productImages/ladiestank/Grey_Frost-th.png',
        Navy_Frost: 'images/productImages/ladiestank/Navy_Frost-th.png',
        Purple_Frost: 'images/productImages/ladiestank/Purple_Frost-th.png',
        Red_Frost: 'images/productImages/ladiestank/Red_Frost-th.png',
        Royal_Frost: 'images/productImages/ladiestank/Royal_Frost-th.png',
        White: 'images/productImages/ladiestank/White-th.png',
      },
    ...
    desc: `<p><strong>The perfect mixture of softness, comfort and easy wear.</strong></p>
          ...
          <p><em>Tri-Blend fabric infuses each garment with unique character. Please allow for slight color variations.</em></p>`,
    sizes: 'xs-4x',
  },
...

  {
    ...
    productImages: {
      items: {
        True_Royal: 'images/productImages/poly/True_Royal.png',
        Atomic_Blue: 'images/productImages/poly/Atomic_Blue.png',
        Black: 'images/productImages/poly/Black.png',
        Cardinal: 'images/productImages/poly/Cardinal.png',
        Carolina_Blue: 'images/productImages/poly/Carolina_Blue.png',
        Deep_Orange: 'images/productImages/poly/Deep_Orange.png',
        Forest_Green: 'images/productImages/poly/Forest_Green.png',
        Gold: 'images/productImages/poly/Gold.png',
        Grey_Concrete: 'images/productImages/poly/Grey_Concrete.png',
        Iron_Grey: 'images/productImages/poly/Iron_Grey.png',
        Kelly_Green: 'images/productImages/poly/Kelly_Green.png',
        Lime_Shock: 'images/productImages/poly/Lime_Shock.png',
        Maroon: 'images/productImages/poly/Maroon.png',
        Neon_Orange: 'images/productImages/poly/Neon_Orange.png',
        Neon_Pink: 'images/productImages/poly/Neon_Pink.png',
        Neon_Yellow: 'images/productImages/poly/Neon_Yellow.png',
        Purple: 'images/productImages/poly/Purple.png',
        Sand: 'images/productImages/poly/Sand.png',
        Silver: 'images/productImages/poly/Silver.png',
        Texas_Orange: 'images/productImages/poly/Texas_Orange.png',
        Tropic_Blue: 'images/productImages/poly/Tropic_Blue.png',
        True_Navy: 'images/productImages/poly/True_Navy.png',
        True_Red: 'images/productImages/poly/True_Red.png',
        Vegas_Gold: 'images/productImages/poly/Vegas_Gold.png',
        White: 'images/productImages/poly/White.png',
      },
      item_thumbnails: {
        True_Royal: 'images/productImages/poly/True_Royal-th.png',
        Atomic_Blue: 'images/productImages/poly/Atomic_Blue-th.png',
        Black: 'images/productImages/poly/Black-th.png',
        Cardinal: 'images/productImages/poly/Cardinal-th.png',
        Carolina_Blue: 'images/productImages/poly/Carolina_Blue-th.png',
        Deep_Orange: 'images/productImages/poly/Deep_Orange-th.png',
        Forest_Green: 'images/productImages/poly/Forest_Green-th.png',
        Gold: 'images/productImages/poly/Gold-th.png',
        Grey_Concrete: 'images/productImages/poly/Grey_Concrete-th.png',
        Iron_Grey: 'images/productImages/poly/Iron_Grey-th.png',
        Kelly_Green: 'images/productImages/poly/Kelly_Green-th.png',
        Lime_Shock: 'images/productImages/poly/Lime_Shock-th.png',
        Maroon: 'images/productImages/poly/Maroon-th.png',
        Neon_Orange: 'images/productImages/poly/Neon_Orange-th.png',
        Neon_Pink: 'images/productImages/poly/Neon_Pink-th.png',
        Neon_Yellow: 'images/productImages/poly/Neon_Yellow-th.png',
        Purple: 'images/productImages/poly/Purple-th.png',
        Sand: 'images/productImages/poly/Sand-th.png',
        Silver: 'images/productImages/poly/Silver-th.png',
        Texas_Orange: 'images/productImages/poly/Texas_Orange-th.png',
        Tropic_Blue: 'images/productImages/poly/Tropic_Blue-th.png',
        True_Navy: 'images/productImages/poly/True_Navy-th.png',
        True_Red: 'images/productImages/poly/True_Red-th.png',
        Vegas_Gold: 'images/productImages/poly/Vegas_Gold-th.png',
        White: 'images/productImages/poly/White-th.png',
      },

    },
    desc: `<p><strong>Lightweight, roomy and highly breathable, these moisture-wicking, value-priced tees feature PosiCharge technology to lock in color and prevent logos from fading.</strong></p>
            <ul>
